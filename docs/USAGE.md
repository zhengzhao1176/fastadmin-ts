...
> 配套文档：项目概览见 [`README.md`](../README.md)，架构设计见 [`ARCHITECTURE.md`](ARCHITECTURE.md)，FastAdmin 官方开发文档见官网 <https://doc.fastadmin.net/>。
...
| 组件 | 触发方式 | 官方文档 |
|------|----------|------|
| SelectPage 动态下拉 | `class="selectpage" data-source="<模块>/selectpage"` | [178](https://doc.fastadmin.net/doc/178.html) |
| 城市选择 | `data-toggle="city-picker"` | [180](https://doc.fastadmin.net/doc/180.html) |
| 日期时间 | `class="datetimepicker"` | [181](https://doc.fastadmin.net/doc/181.html) |
| 日期区间 | `class="datetimerange"` | [736](https://doc.fastadmin.net/doc/736.html) |
| selectpicker 下拉 | `class="selectpicker"` | [182](https://doc.fastadmin.net/doc/182.html) |
| 开关 | `data-toggle="switcher"` | [185](https://doc.fastadmin.net/doc/185.html) |
| 滑块 | `class="slider" data-slider-min/max/step` | [186](https://doc.fastadmin.net/doc/186.html) |
| Fieldlist 键值编辑 | `<dl class="fieldlist" data-name="row[json]">` | [184](https://doc.fastadmin.net/doc/184.html) |
| 标签输入 | `data-role="tagsinput"` | [1207](https://doc.fastadmin.net/doc/1207.html) |
| 自动完成 | `data-role="autocomplete"` | [1206](https://doc.fastadmin.net/doc/1206.html) |
| 文件上传 | `class="faupload"` / `class="fachoose"` | [177](https://doc.fastadmin.net/doc/177.html) · [183](https://doc.fastadmin.net/doc/183.html) |
| 表单验证 | `data-rule="required;email;..."` | [179](https://doc.fastadmin.net/doc/179.html) |
...
如需了解某个功能的完整规格，请查阅 FastAdmin 官方开发文档：<https://doc.fastadmin.net/>
